...
call java -jar AccountManagerConsole.jar -setup -rootPassword password -schema "C:\Users\swcot\Documents\GitHub\AccountManager\db\postgres\AM6_PG9_Schema.sql" -rocketSchema "C:\Users\swcot\Documents\GitHub\AccountManager\db\postgres\Rocket_PG9_Schema.sql" -confirm
