...
public class AuthorizationService {
	...
	public static BasePermissionType getPermission(String name, OrganizationType organization) throws FactoryException, ArgumentException
	{
		return Factories.getPermissionFactory().getPermissionByName(name, organization);
	}
	...
	{
		return getPermission("RoleEdit", organization);
	}
	...
	{
		return getPermission("RoleCreate", organization);
	}
	...
	{
		return getPermission("RoleView", organization);
	}
	...
	{
		return getPermission("RoleDelete", organization);
	}
	...
	{
		return getPermission("ObjectEdit", organization);
	}
	...
	{
		return getPermission("ObjectCreate", organization);
	}
	...
	{
		return getPermission("ObjectView", organization);
	}
	...
	{
		return getPermission("ObjectDelete", organization);
	}
	...
	{
		return getPermission("ApplicationEdit", organization);
	}
	...
	{
		return getPermission("ApplicationCreate", organization);
	}
	...
	{
		return getPermission("ApplicationView", organization);
	}
	...
	{
		return getPermission("ApplicationDelete", organization);
	}
	...
	{
		return getPermission("DataEdit", organization);
	}
	...
	{
		return getPermission("DataCreate", organization);
	}
	...
	{
		return getPermission("DataView", organization);
	}
	...
	{
		return getPermission("DataDelete", organization);
	}
	...
	{
		return getPermission("GroupEdit", organization);
	}
	...
	{
		return getPermission("GroupCreate", organization);
	}
	...
	{
		return getPermission("GroupView", organization);
	}
	...
	{
		return getPermission("GroupDelete", organization);
	}
	...
	public static boolean canChangeRole(UserType user, BaseRoleType role) throws ArgumentException, FactoryException{
		...
		// OK if the account participation on the role is affected with RoleEdit or RoleCreate permissions with a 
		//

		//Factories.getRoleParticipationFactory().GetAccountRoleParticipants(role, account);
		/*
		if (
			checkRolePermissions(user, role, new BasePermissionType[] { getEditRolePermission(role.getOrganization()), getCreateRolePermission(role.getOrganization()) })
		)
		{
			return true;
		}
	...
	public static boolean canViewRole(UserType user, BaseRoleType role) throws ArgumentException, FactoryException{
		...
		// OK if the account participation on the role is affected with RoleView permissions
		//

		//Factories.getRoleParticipationFactory().GetAccountRoleParticipants(role, account);
		/*
		if (
			checkRolePermissions(user, role, new BasePermissionType[] { getEditRolePermission(role.getOrganization()), getViewRolePermission(role.getOrganization()) })
		)
		{
			return true;
		}
	...
	public static boolean canDeleteRole(UserType user, BaseRoleType role) throws ArgumentException, FactoryException{
		...
		/*
		if (
			checkRolePermissions(user, role, new BasePermissionType[] { getDeleteRolePermission(role.getOrganization()) })
		)
		{
			return true;
		}
...
/*
		if (
			checkDataPermissions(role, data, new BasePermissionType[] { getDeleteDataPermission(data.getOrganization())})
		)
		{
			return true;
		}
*/
	...
	public static boolean canDeleteData(UserType user, DataType data) throws ArgumentException, FactoryException
	{
		...
		/*
		if (
			checkDataPermissions(user, data, new BasePermissionType[] { getDeleteDataPermission(data.getOrganization()) })
		)
		{
			return true;
		}
		...
		///
		long part_id = ParticipationUtil.getParticipationForMapFromDataRole(user, data, getDeleteDataPermission(data.getOrganization()), AffectEnumType.GRANT_PERMISSION);
		if (part_id > 0)
		{
			return true;
		}
	...
	public static boolean canChangeData(UserType user, DataType data) throws ArgumentException, FactoryException
	{
		...
		/*
		if (
			checkDataPermissions(user, data, new BasePermissionType[] { getEditDataPermission(data.getOrganization()), getCreateDataPermission(data.getOrganization()) })
		)
		{
			return true;
		}
		...
		/// Check Participation Map for data<-> permission  <-> role <-> account
		///
		long part_id = ParticipationUtil.getParticipationForMapFromDataRole(user, data, getEditDataPermission(data.getOrganization()), AffectEnumType.GRANT_PERMISSION);
		if (part_id > 0)
		{
			return true;
		}
    ...
    public static boolean canViewData(BaseRoleType role, DataType data) throws FactoryException, ArgumentException
    {
        ...
        if (
            checkDataPermissions(role, data, new BasePermissionType[] { getViewDataPermission(data.getOrganization()) })
        )
        {
            return true;
        }
...
/*
        if (
            checkDataPermissions(user, data, new BasePermissionType[] { getViewDataPermission(data.getOrganization()) })
        )
        {
            return true;
        }
        ...
        /// Check Participation Map for data<-> permission  <-> role <-> account
        ///
        long part_id = ParticipationUtil.getParticipationForMapFromDataRole(user, data, getViewDataPermission(data.getOrganization()), AffectEnumType.GRANT_PERMISSION);
        if (part_id > 0)
        {
            return true;
        }
...
*/
    ...
    public static boolean canCreateDataXXX(BaseRoleType role, DataType data) throws FactoryException, ArgumentException
    {
        ...
        /*
        if (
            checkDataPermissions(role, data, new BasePermissionType[] { getCreateDataPermission(data.getOrganization()) })
        )
        {
            return true;
        }
...
/*
        if (
            checkDataPermissions(user, data, new BasePermissionType[] { getCreateDataPermission(data.getOrganization()) })
        )
        {
            return true;
        }
        ...
        /// Check Participation Map for data<-> permission  <-> role <-> account
        ///
        long part_id = ParticipationUtil.getParticipationForMapFromDataRole(user, data, getCreateDataPermission(data.getOrganization()), AffectEnumType.GRANT_PERMISSION);
        if (part_id > 0)
        {
            return true;
        }
        ...
        return false;
        */
        return EffectiveAuthorizationService.getDataAuthorization(user,data, new BasePermissionType[] { getCreateDataPermission(data.getOrganization())} );
    }
	...
	public static boolean canChangeGroup(BaseRoleType role, BaseGroupType group) throws FactoryException, ArgumentException
	{
		...
		if (
			...
			||
			(
				(group.getGroupType() == GroupEnumType.ACCOUNT || group.getGroupType() == GroupEnumType.USER)
				&&
    ...
    public static boolean canDeleteGroup(BaseRoleType role, BaseGroupType group) throws FactoryException, ArgumentException
    {
        ...
        if (
            ...
            ||
            (
                group.getGroupType() == GroupEnumType.ACCOUNT
                &&
                RoleService.getAccountAdministratorAccountRole(group.getOrganization()).getId() == role.getId()
            )
        )
    ...
    public static boolean canDeleteGroup(UserType user, BaseGroupType group) throws ArgumentException, FactoryException
    {
        ...
        /*
        if (
            checkGroupPermissions(user, group, new BasePermissionType[] { getDeleteGroupPermission(group.getOrganization()) })
        )
        {
            return true;
        }
        long part_id = ParticipationUtil.getParticipationForMapFromGroupRole(user, group, getDeleteGroupPermission(group.getOrganization()), AffectEnumType.GRANT_PERMISSION);
        if(part_id > 0){
        	return true;
        }
        return false;
	...
	public static boolean canViewGroup(BaseRoleType role, BaseGroupType group) throws FactoryException, ArgumentException
	{
		...
		/*
		if (
			checkGroupPermissions(role, group, new BasePermissionType[] { getViewGroupPermission(group.getOrganization()) })
		)
		{
			return true;
		}
	...
	public static boolean canViewGroup(UserType user, BaseGroupType group) throws ArgumentException, FactoryException
	{
		...
		/*
		if (
			checkGroupPermissions(user, group, new BasePermissionType[] { getViewGroupPermission(group.getOrganization()) })
		)
		{
			return true;
		}
        long part_id = ParticipationUtil.getParticipationForMapFromGroupRole(user, group, getViewGroupPermission(group.getOrganization()), AffectEnumType.GRANT_PERMISSION);
        if(part_id > 0){
        	return true;
        }
		return false;
	...
	public static boolean canCreateGroup(BaseRoleType role, BaseGroupType group) throws FactoryException, ArgumentException
	{
		...
		/*
		if (
			checkGroupPermissions(role, group, new BasePermissionType[] { getCreateGroupPermission(group.getOrganization()) })
		)
		{
			return true;
		}
	...
	public static boolean canCreateGroup(UserType user, BaseGroupType group) throws ArgumentException, FactoryException
	{
		...
		/*
		if (
			checkGroupPermissions(user, group, new BasePermissionType[] { getCreateGroupPermission(group.getOrganization()) })
		)
		{
			return true;
		}
        long part_id = ParticipationUtil.getParticipationForMapFromGroupRole(user, group, getCreateGroupPermission(group.getOrganization()), AffectEnumType.GRANT_PERMISSION);
        if(part_id > 0){
        	return true;
        }
	...
	///
	   ...
	   public static boolean REFACTORcanViewObject(BaseRoleType role, NameIdDirectoryGroupType obj) throws FactoryException, ArgumentException
	    {

	        if (RoleService.getObjectAdministratorUserRole(obj.getOrganization()).getId().compareTo(role.getId())==0)
	        {
	            return true;
	        }
	        if(RoleService.getObjectReaderUserRole(obj.getOrganization()).getId().compareTo(role.getId())==0){
	        	return true;
	        }

	        if (
	            checkGroupPermissions(role, obj.getGroup(), new BasePermissionType[] { getViewObjectPermission(obj.getOrganization()) })
	        )
	        {
	            return true;
	        }
	    ...
	    public static boolean REFACTORcanViewObject(UserType user, NameIdDirectoryGroupType obj) throws ArgumentException, FactoryException
	    {

	        if (isMapOwner(user, obj))
	        {
	            return true;
	        }
	        if(isObjectReaderInMapOrganization(user,obj.getGroup())){
	        	return true;
	        }
	        if (isObjectAdministratorInMapOrganization(user, obj.getGroup()))
	        {
	            return true;
	        }

	        if (
	            checkGroupPermissions(user, obj.getGroup(), new BasePermissionType[] { getViewDataPermission(obj.getOrganization()) })
	        )
	        {
	            return true;
	        }
	        ...
	        /// Check Participation Map for data<-> permission  <-> role <-> account
	        ///
	        long part_id = ParticipationUtil.getParticipationForMapFromGroupRole(user, obj.getGroup(), getViewObjectPermission(obj.getOrganization()), AffectEnumType.GRANT_PERMISSION);
	        if (part_id > 0)
	        {
	            return true;
	        }
	    ...
	    public static boolean REFACTORcanDeleteObject(BaseRoleType role, NameIdDirectoryGroupType obj) throws FactoryException, ArgumentException
		{

			if (RoleService.getObjectAdministratorAccountRole(obj.getOrganization()).getId().compareTo(role.getId())==0)
			{
				return true;
			}

			if (
				checkGroupPermissions(role, obj.getGroup(), new BasePermissionType[] { getDeleteObjectPermission(obj.getOrganization()), getCreateObjectPermission(obj.getGroup().getOrganization()) })
			)
			{
				return true;
			}
		...
		public static boolean REFACTORcanDeleteObject(UserType user, NameIdDirectoryGroupType obj) throws ArgumentException, FactoryException
		{
			...
			if (isObjectAdministratorInMapOrganization(user,obj))
			{
				return true;
			}

			if (
				checkGroupPermissions(user, obj.getGroup(), new BasePermissionType[] { getDeleteObjectPermission(obj.getOrganization()), getCreateObjectPermission(obj.getOrganization()) })
			)
			{
				return true;
			}
			...
			/// Check Participation Map for data<-> permission  <-> role <-> account
			///
			long part_id = ParticipationUtil.getParticipationForMapFromGroupRole(user, obj.getGroup(), getDeleteObjectPermission(obj.getOrganization()), AffectEnumType.GRANT_PERMISSION);
			if (part_id > 0)
			{
				return true;
			}
		...
		public static boolean REFACTORcanChangeObject(BaseRoleType role, NameIdDirectoryGroupType obj) throws FactoryException, ArgumentException
		{
			...
			if (
				checkGroupPermissions(role, obj.getGroup(), new BasePermissionType[] { getEditObjectPermission(obj.getOrganization()), getCreateObjectPermission(obj.getGroup().getOrganization()) })
			)
			{
				return true;
			}
		...
		public static boolean REFACTORcanChangeObject(UserType user, NameIdDirectoryGroupType obj) throws ArgumentException, FactoryException
		{
			...
			if (
				checkGroupPermissions(user, obj.getGroup(), new BasePermissionType[] { getEditObjectPermission(obj.getOrganization()), getCreateObjectPermission(obj.getOrganization()) })
			)
			{
				return true;
			}
			...
			/// Check Participation Map for data<-> permission  <-> role <-> account
			///
			long part_id = ParticipationUtil.getParticipationForMapFromGroupRole(user, obj.getGroup(), getEditObjectPermission(obj.getOrganization()), AffectEnumType.GRANT_PERMISSION);
			if (part_id > 0)
			{
				return true;
			}
